...
import com.illegalaccess.feign.okhttp.interceptor.SeparateInterceptor;
...
@MultiFeignClient(name = "okHttpApi", url = "http://127.0.0.1:8080", clientPoolName = "okHttpPool", logLevel = LogLevelEnum.FULL, interceptors = {SeparateInterceptor.class})
